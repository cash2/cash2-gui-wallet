...
public:
  enum Columns{
    COLUMN_STATE = 0, COLUMN_DATE, COLUMN_AMOUNT_WITH_FEE, COLUMN_FEE, COLUMN_ADDRESS, COLUMN_PAYMENT_ID, COLUMN_HASH,
    COLUMN_HEIGHT, COLUMN_TYPE, COLUMN_AMOUNT_WITHOUT_FEE, COLUMN_BALANCE
  };
...
private:
  ...
  QVariant getBackgroundRole(const QModelIndex& _index) const;
